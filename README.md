hnscl-python2-python-rpm
========================

A Dockerfile to build the latest python2 rpm in software collection hnscl-python2 for CentOS 7 using [copr](https://copr.fedoraproject.org/).
